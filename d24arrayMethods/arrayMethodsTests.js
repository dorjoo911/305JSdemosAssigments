...
describe("copySorted", function () {
  it("make a copy and run the sort on it", function () {
    ...
    assert.deepEqual(copySorted(arr9), ["CSS", "HTML", "JavaScript"]);
  });
});
...
describe("shuffle", function () {
  it("shuffles (randomly reorders) elements of the array.", function () {
    let array1 = [1, 2, 3];
    assert.deepEqual(shuffle(array1), [3, 2, 1] || [2, 1, 3] || [3, 1, 2]);
  });
});
